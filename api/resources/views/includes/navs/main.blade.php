...
<nav class="bg-blue-600 border-gray-200">
    ...
    <a href="https://flowbite.com/" class="flex items-center space-x-3">
        <img src="https://upload.wikimedia.org/wikipedia/commons/5/55/Forza_logo_2020.svg" class="h-8"/>
        <span class="text-2xl font-semibold">Archive</span>
    </a>
    <div class="flex md:order-2">
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
        ...
        <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
          <li>
            <a href="{{ route('home') }}" class="block py-2 px-3 text-xl text-gray-900 rounded hover:text-white" aria-current="page">Home</a>
          </li>
          <li>
            <a href="{{ route('admin.index') }}" class="block py-2 px-3 text-xl text-gray-900 rounded hover:text-white" aria-current="page">Admin</a>
          </li>
          <li>
            <a href="{{ route('brands.index') }}" class="block py-2 px-3 text-xl text-gray-900 rounded hover:text-white" aria-current="page">Brands</a>
          </li>
          <li>
            <a href="{{ route('cars.index') }}" class="block py-2 px-3 text-xl text-gray-900 rounded hover:text-white" aria-current="page">Cars</a>
          </li>
        </ul>
      </div>
    </div>
